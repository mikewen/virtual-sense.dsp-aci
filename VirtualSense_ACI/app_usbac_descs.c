...
#pragma DATA_ALIGN(deviceDescriptorB, 2);
...
#pragma DATA_ALIGN(deviceQualifierDescr, 2);
...
#pragma DATA_ALIGN(configDescriptor, 2);
...
/* Start of Class-Specific AudioControl Interface Descriptor section */
...
#ifdef BIDIR_TERM_TYPE_HEADSET
    LEB(0x0402),    /* wTerminalType=HEADSET */
    T_OT_SPKR,      /* wTerminalType=Speaker Output Terminal ID */
#else
    ...
    LEB(0x0001),    /* bmaControlMaster-Mute */
    LEB(0x0002),    /* bmaControl-Left Channel Volume */
    LEB(0x0002),    /* bmaControl-Right Channel Volume */
    0x00,           /* iFeature=NONE */
...
#ifdef BIDIR_TERM_TYPE_HEADSET
    LEB(0x0402),    /* wTerminalType=HEADSET */
    T_IT_MIC_REC,   /* bAssocTerminal=Microphone Input Terminal ID */
#else
...
/* End of Class-Specific AudioControl Interface Descriptor section */
    ...
    REC_FMT_TYPEI_DESCR_SZ, /* bLength, in bytes */
    0x24,           /* bDescriptorType=CS_INTERFACE */
    ...
    REC_NUM_SAMP_RATES, /* bSamFreqType=N Discrete Sampling Frequencies */
    REC_FMT_TYPEI_DESCR_SAMP_RATES,
    ...
    0x01,           /* bDescriptorSubtype */
#ifdef ENABLE_REC_MULT_SAMP_RATES
    ...
    /* Class-Specific Format Type 1 Audio Descriptor */
    PB_FMT_TYPEI_DESCR_SZ, /* bLength, in bytes */
    0x24,           /* bDescriptorType=CS_INTERFACE */
    0x02,           /* bDescriptorSubtype=FORMAT_TYPE */
    ...
    PB_NUM_SAMP_RATES, /* bSamFreqType=N Discrete Sampling Frequencies */
    PB_FMT_TYPEI_DESCR_SAMP_RATES, 
...
#ifdef ENABLE_PB_MULT_SAMP_RATES
    0x01,           /* bmAttributes=Sampling Frequency Control, full packet not necessary */
#else
    0x00,           /* bmAttributes=no controls, full packet not necessary */
#endif
...
#pragma DATA_ALIGN(acHidReportDescriptor, 2);
